...
class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
	 ...
	 * @param array   $linkmod_classes array to hold linkmod classes.
	 * @param array   $icon_classes    array to hold icon classes.
	...
	private function separate_linkmods_and_icons_from_classes( $classes, &$linkmod_classes, &$icon_classes, $depth ) {
		...
		foreach ( $classes as $key => $class ) {
			...
			if ( preg_match( '/^disabled|^sr-only/i', $class ) ) {
				...
				$linkmod_classes[] = $class;
				unset( $classes[ $key ] );
			} elseif ( preg_match( '/^fa-|^fab-|^fas-|^far-|^fal-|^fad-|^fab-|^fa-solid-|^fa-regular-|^fa-light-|^fa-thin-|^fa-duotone-|^fa-brands-/i', $class ) ) {
				// Font Awesome.
				$icon_classes[] = $class;
				unset( $classes[ $key ] );
			} elseif ( preg_match( '/^glyphicon-/i', $class ) ) {
				// Glyphicons.
				$icon_classes[] = $class;
				unset( $classes[ $key ] );
			}
	...
	private function update_atts_for_linkmod_type( $atts = array(), $linkmod_classes = array() ) {
		// Update $atts with a type and href class.
		if ( ! empty( $linkmod_classes ) ) {
			foreach ( $linkmod_classes as $link_class ) {
				if ( ! empty( $link_class ) ) {
					...
					// Set sr-only links to tabindex -1.
